...
/**
 * Представление для pdf документов
 */
public class PDFDpcument extends AbstractPdfView{
	@Override
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter pdfWriter, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		PdfPCell header2 = new PdfPCell(new Phrase("Color"));
		PdfPCell header3 = new PdfPCell(new Phrase("Weight"));
