	...
	<jsp:body>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md4">
					<c:if test="${pageContent.request.getParameter('resultSending') == 'true'}">
						<h3 style="color: green">Email already send!</h3>
					</c:if>
					<c:if test="${pageContent.request.getParameter('resultSending') == 'false'}}">
						<h3 style="color: red">Email wasn't send!</h3>
					</c:if>
					<h3>Contact Details</h3>
					<p>
						13/1 Dobrovolskogog str. <br>Rostov-on-Don, 344092 <br>
					</p>
			...
			<div class="row">
				<div class="col-md-8">
					...
					<form:form name="sentMessage" id="contactForm" action="${send}" method="post" modelAttribute="emailModel" novalidate="true">
