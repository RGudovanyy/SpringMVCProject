			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="list-group">
						...
						<a href="${jdbcUpdate}/user/username/user@anviprj.net/enabled/false" class="list-group-item">Update user</a>
					</div>
				</div>
				<!-- Content Column -->
				<div class="col-md-9">
					<c:if test="${not empty resultObject}">
						...
						<c:if test="${resultObject != 'true' and resultObject != 'false'}"><p>${resultObject}</p>							
						</c:if>
					</c:if>
				</div>
			</div>
