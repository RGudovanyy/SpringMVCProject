package net.anviprojects.SpringMVCProject.mvc.cookie;
...
public class CookieController {
    ...
    public String writeCookieExample(HttpServletRequest request, HttpServletResponse response){
        System.out.println("CookieController.writeCookieExample() is called");
    ...
    public ModelAndView readAllCookiesExample(HttpServletRequest request){
        System.out.println("CookieController.readAllCookiesExample() is called");
        Cookie[] cookies = request.getCookies();
        System.out.println("All Cookies in your browser");
        String cookieStr = "";
        for (Cookie cookie : cookies){
            System.out.println(cookie.getName() + " : " + cookie.getValue());
            cookieStr += cookie.getName() + " : " + cookie.getValue() + " : " + cookie + "<br/>";
        }
        return new ModelAndView("/cookie/cookieView", "cookieValueObj", cookieStr);
    }
